...
<%     
		...
		if(rs.next())
			out.println("Mobile N.o already registered!");
		else
		{	
			PreparedStatement ps=con.prepareStatement("insert into clientdet values(?,?,?,?,?,?,?,?,?,?)");
			ps.setString(1,request.getParameter("SIM"));
			ps.setString(2,request.getParameter("MOB"));
			...
			ps.setString(7,request.getParameter("Contype"));
			ps.setString(8,request.getParameter("Constatus"));
			ps.setString(9,request.getParameter("Country"));
			ps.setString(10,request.getParameter("PIN"));
			int succ=ps.executeUpdate();
			if(succ==1)
				out.println("Client Registration Successful!");
			ps.close();
	
			if(request.getParameter("Contype").equalsIgnoreCase("Prepaid"))
			{		
			...
			else if (request.getParameter("Contype").equalsIgnoreCase("Postpaid"))
			{		
...
{
	out.println("Sim Already registered");		
}
catch(Exception e)
{
