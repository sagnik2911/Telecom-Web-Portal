...
<li><a href="Register.html">Register</a></li>
	 ...
	 try{
			...
			ResultSet rs=st.executeQuery("select * from userdet where MOB_NO='"+request.getParameter("MOB")+"'");
			boolean found=false;
			if(rs.next())
			{	
				found = true;
				out.println("<form name=f1 method=post action=Editcomplete.jsp>");
				...
				out.println("<td><input type=text name=Uname value='"+rs.getString(1)+"' readonly style=background-color:Gainsboro></td>");
				out.println("</tr>");
				out.println("<tr>");
				out.println("<th>MOB NO:</th>");
				out.println("<td><input type=text value='"+rs.getString(2)+"' readonly style=background-color:Gainsboro></td>");
				out.println("<td><input type=text name=MOB value='"+rs.getString(2)+"' readonly style=background-color:Gainsboro></td>");
				out.println("</tr>");
				out.println("<tr>");
				out.println("<th>Password:</th>");
				out.println("<td><input type=text value='"+rs.getString(3)+"' readonly style=background-color:Gainsboro></td>");
				out.println("<td><input type=text name=Pass value='"+rs.getString(3)+"'></td>");
				out.println("</tr>");
				out.println("<tr>");
				...
				out.println("<tr>");
				out.println("<td colspan=1 bgcolor=white>&nbsp;</td>");
				out.println("<td align=right><input type=Submit value=Submit></td>");
				out.println("</tr>");
				out.println("</table>");
				out.println("</form>");
			}
