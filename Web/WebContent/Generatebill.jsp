...
<li><a href="Register.html">Register</a></li>
	 ...
	 try{
			...
			ResultSet rs=st.executeQuery("select * from postpaid where MOB_NO='"+request.getParameter("MOB")+"'");
			if(rs.next())
			{
				out.println("<form name=f1 method=post action=Bill.jsp>");
				out.println("<table cellpadding=10>");
				out.println("<tr>");
				out.println("<td colspan=1 bgcolor=white>&nbsp;</td>");
				out.println("<th>Bill details</th>");
				out.println("</tr>");
				out.println("<tr>");
				out.println("<th>MOB NO:</th>");
				out.println("<td><input type=text name=MOB value='"+rs.getString(1)+"' readonly style=background-color:Gainsboro></td>");
				out.println("</tr>");
				out.println("<tr>");
				out.println("<th>Prev Bill due:</th>");
				out.println("<td><input type=text name=PBILL value='"+rs.getInt(2)+"' readonly style=background-color:Gainsboro></td>");
				out.println("</tr>");
				out.println("<tr>");
				out.println("<th>Current bill:</th>");
				out.println("<td><input type=text name=CBILL></td>");
				out.println("</tr>");
				out.println("<tr>");
				out.println("<td colspan=1 bgcolor=white>&nbsp;</td>");
				out.println("<td><input type=button value=Submit onClick=check()></td>");
				out.println("</tr>");
				out.println("</table>");
				out.println("</form>");
			}
			else
			{
				...
				out.println("</tr>");
				out.println("<tr>");
				out.println("<th align=center><font color=Orange>Not a registered postpaid Mobile number !</font></th>");
				out.println("</tr>");
				out.println("<tr>");
				out.println("<td colspan=1 bgcolor=white>&nbsp;</td>");
				out.println("<td colspan=1 bgcolor=white>&nbsp;</td>");
...
function check()
{
    ...
    if(isNaN(amo))
  	{
  		alert("Not a valid amount entered");
