...
try{
	...
	int total=Integer.parseInt(request.getParameter("PBILL"))+Integer.parseInt(request.getParameter("CBILL"));
	String id=request.getParameter("ID");
	PreparedStatement ps=con.prepareStatement("update bill set CURR_BILL=?,PREV_DUE=?,TOT_BILL=? where BLID='"+request.getParameter("ID")+"'");
	ps.setInt(1,Integer.parseInt(request.getParameter("CBILL")));
	ps.setInt(2,Integer.parseInt(request.getParameter("PBILL")));
	ps.setInt(3,total);
	ps.executeUpdate();
	
	PreparedStatement ps1=con.prepareStatement("update postpaid set BILLDUE=?  where MOB_NO='"+request.getParameter("MOB")+"'");
	ps1.setInt(1,total);
	ps1.executeUpdate();
